...
<body>
  ...
  <script>
    const quizData = [
      ...
      { q: "Tujuan sistem Tanam Paksa adalah…", options: ["Mensejahterakan petani lokal", "Menambah pendapatan pemerintah Belanda", "Mengurangi pengangguran", "Membebaskan rakyat dari pajak"], answer: 1 },
